    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-primary">Encaminhamentos</h2>
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <ExportExcelButton
                        data={items.map(item => ({
                            ...
                            'Profissional': item.professional?.name || item.professionalName || '—',
